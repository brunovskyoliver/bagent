...
- [ ] Handle model/BaseRT/connector/network failures, approval denial/timeout, repeated failures, and daemon shutdown during a run without infinite retries or silent disablement.
